!(function(e, t) {
    ...
    const q = { previousBodyPadding: null },
        ...
        se = (e) => {
            var t = (() => {
                ...
                return (!!e &&
                    (e.remove(),
                        _(
                            [document.documentElement, document.body], [h["no-backdrop"], h["toast-shown"], h["has-column"]]
                        ), !0)
                );
            })();
        ...
        de = (e, t) => {
            ...
            var o = S(),
                ...
                a = P(),
                s = T();
            t.showDenyButton || t.showCancelButton || J(n),
                U(n, t, "actions"),
                pe(i, "confirm", t),
                pe(a, "deny", t),
                pe(s, "cancel", t),
    ...
    function it(e, t, n, o) {
        H() ?
            ...
            _(
                [document.documentElement, document.body], [h.shown, h["height-auto"], h["no-backdrop"], h["toast-shown"]]
            );
    }
                ...
                new Promise((e) => {
                    ...
                    ot.swalPromiseResolve.set(s, e),
                        ...
                        (a.keydownTarget.removeEventListener(
                                "keydown",
                                a.keydownHandler, { capture: a.keydownListenerCapture }
                            ),
